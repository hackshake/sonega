...
$game=$_REQUEST['game'];
$game_row="game".$game;
$query=mysqli_query($conn,"update interests set game$game=1 where userid='$uname'");
...
while($games_array=mysqli_fetch_array($games,MYSQLI_ASSOC))
{
	...
	if($interests_array[$ii+1]==1)
	{
		...
		echo"<span class='glyphicon glyphicon-remove' style='color:red' id='buttonid' onclick=\"remove('$uname','$games_array[id]')\"></span><br>";
		$c=1;
